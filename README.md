...
```bash
git clone https://github.com/SanjayTummala/plgarismchecker
```
...
You have to use own python library or you can use a existing python library from internet.

## Explore it 

Explore it and twist it to your own use case. In case of any questions feel free to reach me directly at *sanjaytummala18@gmail.com*.
...
All the credit goes to [Sanjay Kumar](https://github.com/SanjayTummala).
